defmodule SchoolAppWeb.StudentDomainLive do
  ...
  def mount(_params, _session, socket) do
    ...
    link_dm = SchoolAppWeb.AppUtils.get_item(:domains)
  ...
  def render(assigns) do
    ...
    <CustomComponents.link_button link={@link_dm.link} icon={@link_dm.icon}>
      <%= @link_dm.name %>
    </CustomComponents.link_button>
