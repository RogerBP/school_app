defmodule SchoolAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SchoolAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SchoolAppWeb.Gettext, "errors", msg, opts)
    end
  end
